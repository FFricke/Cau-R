...
diagramm_hist_ca(data = filter_ca, element = As, variable = culture_id, spectrum = col_culture, labelling = lab_en_culture)
diagramm_hist_ca(data = filter_ca, element = Ni, variable = culture_id, spectrum = col_culture, labelling = lab_en_culture)
diagramm_hist_ca(data = filter_ca, element = Sb, variable = culture_id, spectrum = col_culture, labelling = lab_en_culture)
diagramm_hist_ca(data = filter_ca, element = Zn, variable = culture_id, spectrum = col_culture, labelling = lab_en_culture)